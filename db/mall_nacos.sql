...
INSERT INTO `config_info` VALUES (6, 'application.yml', 'dev', '# 端口\r\nserver:\r\n  port: 9000\r\n\r\n# 数据源\r\nspring:\r\n  datasource:\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    url: jdbc:mysql://192.168.56.10:3306/mall_product\r\n    username: root\r\n    password: 987654\r\n\r\n# mapper映射地址\r\nmybatis-plus:\r\n  mapper-locations: classpath:/mapper/**/*.xml\r\n#  主键自增\r\n  global-config:\r\n    db-config:\r\n      id-type: auto', '71abb89da4a4ac484ad3a3a345ca21dd', '2022-02-10 09:55:00', '2022-02-10 09:55:00', 'nacos', '127.0.0.1', '', 'eb41d029-6c65-47df-9cdb-a17752e6d6ab', NULL, NULL, NULL, 'yaml', NULL);
