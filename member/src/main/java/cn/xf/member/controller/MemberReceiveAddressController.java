...
public class MemberReceiveAddressController {
    ...
    public List<MemberReceiveAddressEntity> getMemberReceiveAddress(@PathVariable("member") Long memberId){
        return memberReceiveAddressService.getMemberReceiveAddress(memberId);
    }
