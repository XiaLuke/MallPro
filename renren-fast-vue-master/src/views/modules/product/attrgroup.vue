  ...
  <el-row :gutter="20">
    ...
    <el-col :span="18">
      <div class="mod-config">
        ...
        <!-- 修改关联关系 -->
        <relation-update v-if="relationVisible" ref="relationUpdate" @refreshData="getDataList"/>
      </div>
    </el-col>
  </el-row>
</template>
...
import AddOrUpdate from './modules/attrgroup-add-or-update'
import RelationUpdate from './modules/attr-group-relation'
