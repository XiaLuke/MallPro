package cn.xf.seckill.service.impl;

import cn.xf.common.utils.R;
import cn.xf.seckill.feign.CouponFeignService;
import cn.xf.seckill.feign.ProductFeignService;
import cn.xf.seckill.service.SeckillService;
import cn.xf.seckill.to.SeckillSkuRedisTo;
import cn.xf.seckill.vo.SeckillSessionWithSkusVo;
import cn.xf.seckill.vo.SkuInfoVo;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    public void uploadSeckillSkuLatest3Days() {
        ...
        R lasted3DaySession = couponFeignService.getLasted3DaySession();
        if (lasted3DaySession.getCode() == 0) {
            //上架商品
            List<SeckillSessionWithSkusVo> sessionData = lasted3DaySession.getData("data", new TypeReference<List<SeckillSessionWithSkusVo>>() {
            });
            //缓存到Redis
            //1、缓存活动信息
